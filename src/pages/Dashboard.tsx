                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {newusers.map((usuario) => (
                      <tr key={usuario.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">{usuario.district}</td>
                        <td className="px-6 py-4 whitespace-nowrap">{usuario.phone}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
